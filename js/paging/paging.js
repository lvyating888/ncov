            ...
            return t.fn.Paging = function(i) {
                ...
                e.prototype = {
                    ...
                    bindToolbar: function() {
                        for (var i = this,
                                 e = t('<li class="ui-paging-toolbar"><select class="ui-select-pagesize"></select><input type="text" class="ui-paging-count"/><a href="javascript:void(0)">跳转</a></li>'),
                                 totalNumber =t('<li class="totalNumber"><span id="totalNumber">共有'+this.count+'条</span></li>'),
                                 s = t(".ui-select-pagesize", e),
                                 a = "", n = 0, r = this.settings.pageSizeList.length; n < r; n++) a += '<option value="' + this.settings.pageSizeList[n] + '">'
                            + this.settings.pageSizeList[n] + "条/页</option>";
                        s.html(a),
                            s.val(this.pagesize),
                        ...
                        this.container.children("ul").append(e) && this.totalNumber()
                    },
                    totalNumber:function () {
                        var  totalNumber =t('<li class="totalNumber"><span id="totalNumber">共有'+this.count+'条</span></li>');
                        this.container.children("ul").append(totalNumber)
                    }
                },
                e
        });